<!--================================================== -->
		...
		<script src="/lib/HTML_Full_Version/js/plugin/datatables/jquery.dataTables.min.js"></script>
		<script src="/lib/HTML_Full_Version/js/plugin/datatables/dataTables.colVis.min.js"></script>
		<script src="/lib/HTML_Full_Version/js/plugin/datatables/dataTables.tableTools.min.js"></script>
		<script src="/lib/HTML_Full_Version/js/plugin/datatables/dataTables.bootstrap.min.js"></script>
		<script src="/lib/HTML_Full_Version/js/plugin/datatable-responsive/datatables.responsive.min.js"></script>
	
		<!-- datatable 을 쓰기위한 script 2017-05-18--> 
		<script src="/lib/js/template_js/datatable.js"></script>

		<!-- PAGE RELATED PLUGIN(S) -->
		<script src="/lib/HTML_Full_Version/js/plugin/bootstrap-wizard/jquery.bootstrap.wizard.min.js"></script>
		<script src="/lib/HTML_Full_Version/js/plugin/fuelux/wizard/wizard.min.js"></script>
		<script src="/lib/js/template_js/wizard.js"></script>

		<!-- form validation plugin 2017-05-18-->
		<script src="/lib/HTML_Full_Version/js/plugin/bootstrapvalidator/bootstrapValidator.min.js"></script>	

		<!-- 현장등록 form validation 을 쓰기위한 script  2017-05-21-->
		<script src="/lib/js/template_js/formValidation_hyunjang.js"></script>
		<script src="/lib/js/template_js/formValidation_daily.js"></script>
		
		<!-- 나의 js 파일 2017-05-18--> 
		<script src="/lib/js/sidebar.js"></script>
		<script src="/lib/js/enroll_danga.js"></script>
		<script src="/lib/js/enroll_kosu.js"></script>
