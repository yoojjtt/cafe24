												...
												<div id="bootstrap-wizard-1" class="col-sm-12">
													<div class="form-bootstrapWizard">
														<ul class="bootstrapWizard form-wizard">
															...
															<li data-target="#step2">
																<a href="#tab2" data-toggle="tab"> <span class="step">2</span> <span class="title">근로자 등록</span> </a>
															</li>
															<li data-target="#step3">
																<a href="#tab3" data-toggle="tab"> <span class="step">3</span> <span class="title">단가입력</span> </a>
															</li>
													...
													<div class="tab-content">
															...
															<div class="row">
																...
																<div class="col-sm-12 col-lg-12">
																	<div class="form-group">
																		...
																		<?$this->load->view('widget/enroll/hyunjang_list_widget');?>
																</div>
														...
														<div class="tab-pane" id="tab2">
															...
															<div class="row">
																<div class="col-sm-5 col-sm-5 col-lg-5 col-md-5">
																	<div class="form-group">
																		<div class="input-group">
																			<span class="input-group-addon"><i class="fa fa-search fa-lg fa-fw"></i></span>
																			<input id="selected_hyunjang_2"class="form-control input-lg" type="text" placeholder="현장을 선택하세요"name="selected_hyunjang" >
																			<input id="selected_hyunjang_num_2" type="hidden"/>
				
																		</div>
																	</div>
																</div>
																<div class="col-sm-3 col-sm-3 col-lg-3 col-md-3">
																	<div class="form-group">
																		<div class="input-group">
																			<span class="input-group-addon"><i class="fa fa-calendar fa-lg fa-fw"></i></span>
																			<input id="monthly_daga_date"class="form-control input-lg"  type="month">
															...
															<div class="row">
																<div class="col-sm-12 col-lg-12">
																<?$this->load->view('widget/enroll/daily_member_list_widget');?>
																</div>
															</div>
														...
														<div class="tab-pane" id="tab3">
															...
															<div class="row">
																	...
																	<div class="col-sm-5 col-sm-5 col-lg-5 col-md-5">
																		<div class="form-group">
																			<div class="input-group">
																				<span class="input-group-addon"><i class="fa fa-calendar fa-lg fa-fw"></i></span>
																				<input id="monthly_daga_date_2"class="form-control input-lg"  type="month"><span style="padding:0px;"class="input-group-addon"><button  id="monthy_daga_search"class="btn btn-success btn-lg"><i class="fa fa-check"></i>조회</button></span>
															...
															<div class="row">
																<div class="col-sm-12 col-lg-12">
																<?$this->load->view('widget/enroll/hyun_jang_register_widget');?>
																</div>
															</div>
														</div>
